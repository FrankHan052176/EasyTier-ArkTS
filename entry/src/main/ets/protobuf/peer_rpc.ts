...
export const HandshakeRequest: MessageFns<HandshakeRequest> = {
  fromJSON(object: any): HandshakeRequest {
    return {
      ...
      network_name: isSet(object.networkName)
        ...
        ? globalThis.String(object.network_name)
        : "",
      network_secret_digrest: isSet(object.networkSecretDigrest)
        ? bytesFromBase64(object.networkSecretDigrest)
        : isSet(object.network_secret_digrest)
  ...
  toJSON(message: HandshakeRequest): unknown {
    ...
    if (message.network_secret_digrest.length !== 0) {
      obj.networkSecretDigrest = base64FromBytes(message.network_secret_digrest);
    }
    return obj;
  },
