...
export interface TunnelInfo {
  ...
  resolved_remote_addr: Url | undefined;
}
...
function createBaseTunnelInfo(): TunnelInfo {
  return { tunnel_type: "", local_addr: undefined, remote_addr: undefined, resolved_remote_addr: undefined };
}
...
export const TunnelInfo: MessageFns<TunnelInfo> = {
  fromJSON(object: any): TunnelInfo {
    return {
      ...
      remote_addr: isSet(object.remoteAddr)
        ...
        : undefined,
      resolved_remote_addr: isSet(object.resolvedRemoteAddr)
        ? Url.fromJSON(object.resolvedRemoteAddr)
        : isSet(object.resolved_remote_addr)
        ? Url.fromJSON(object.resolved_remote_addr)
        : undefined,
    };
  },
  ...
  toJSON(message: TunnelInfo): unknown {
    ...
    if (message.resolved_remote_addr !== undefined) {
      obj.resolvedRemoteAddr = Url.toJSON(message.resolved_remote_addr);
    }
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<TunnelInfo>, I>>(object: I): TunnelInfo {
    ...
    message.remote_addr = (object.remote_addr !== undefined && object.remote_addr !== null)
      ...
      : undefined;
    message.resolved_remote_addr = (object.resolved_remote_addr !== undefined && object.resolved_remote_addr !== null)
      ? Url.fromPartial(object.resolved_remote_addr)
      : undefined;
    return message;
  },
};
  ...
  fromJSON(object: any): PeerFeatureFlag {
    return {
      ...
      no_relay_quic: isSet(object.noRelayQuic)
        ...
        : false,
      is_credential_peer: isSet(object.isCredentialPeer)
        ? globalThis.Boolean(object.isCredentialPeer)
